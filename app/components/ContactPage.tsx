...
export default function ContactPage() {
  ...
  return (
    <section id="contact-form-section" className="bg-paper py-12 text-ink">
      <div className="mx-auto max-w-3xl">
        <div id="partner-form" className="rounded-lg border border-ink/10 bg-bone p-5 shadow-soft sm:p-8">
          {success ? (
            <div className="flex flex-col items-center justify-center py-12 text-center">
              <CheckCircle2 className="h-16 w-16 text-leaf mb-4 animate-bounce" />
